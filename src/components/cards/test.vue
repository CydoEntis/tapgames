...
export default {
  ...
  async checkWhichGameToFetch(likedGames, dislikedGames, lastGame, fullUrl) {
  ...
  async created() {
    ...
    let lastGame = this.checkForLastGame(likedGames, dislikedGames);

    // this.checkWhichGameToFetch(likedGames, dislikedGames, lastGame, fullUrl);
